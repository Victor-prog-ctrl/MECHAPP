...
function buildAppointmentConfirmedEmail({
  ...
  <div style="font-weight:700;font-size:18px;">MechApp</div>
      ...
      <div style="margin-top:12px;padding:12px;border-radius:12px;background-color:#f8fafc;border:1px solid #e2e8f0;">
        <p style="margin:0 0 6px;color:#4b5563;"><strong>Servicio:</strong> ${service || "Sin detalle"
    }</p>
        <p style="margin:0 0 6px;color:#4b5563;"><strong>Fecha y hora:</strong> ${dateLabel || "Por confirmar"
    }</p>
        <p style="margin:0;color:#4b5563;"><strong>Dirección:</strong> ${address || "Revisa tu perfil en MechApp"
    }</p>
      </div>
